...
var Main = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: 'paginate' }, { children: [(0, jsx_runtime_1.jsxs)("div", __assign({ className: 'paginateBox' }, { children: [showTotalRecord && ((0, jsx_runtime_1.jsxs)("div", __assign({ className: 'textPage' }, { children: [titleTotalRecord, ": ", totalCount] }))), showCurrentPage && ((0, jsx_runtime_1.jsx)("div", __assign({ className: 'textPage' }, { children: totalCount && totalCount > pageSize && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [titleCurrentPage, ": ", page] })) }))), showNumberOfPage && ((0, jsx_runtime_1.jsx)("div", __assign({ className: 'textPage' }, { children: totalCount && totalCount > pageSize && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [titleNumberOfPage, ": ", totalPageCount] })) })))] })), totalCount && totalCount > pageSize && ((0, jsx_runtime_1.jsxs)("div", __assign({ className: 'paginateBox' }, { children: [(0, jsx_runtime_1.jsxs)("div", { children: [showPageArrow && ((0, jsx_runtime_1.jsx)("button", __assign({ onClick: function () {
                                    return pageChanging(PaginateType.PREV, 1);
                                }, type: 'button', className: page === 1 ? 'disabled' : '' }, { children: (0, jsx_runtime_1.jsx)(fi_1.FiChevronLeft, {}) }))), showPageNumber && ((0, jsx_runtime_1.jsx)("span", { children: slices.map(function (item) { return ((0, jsx_runtime_1.jsx)("button", __assign({ className: item === page ? 'active' : '', onClick: function () {
                                ...
                                }, type: 'button', className: page === totalPageCount ? 'disabled' : '' }, { children: (0, jsx_runtime_1.jsx)(fi_1.FiChevronRight, {}) })))] }), showPageSelect && ((0, jsx_runtime_1.jsx)("div", __assign({ className: 'selectPage' }, { children: (0, jsx_runtime_1.jsx)("select", __assign({ value: page, onChange: function (event) {
                            ...
                            } }, { children: range.map(function (item) { return ((0, jsx_runtime_1.jsx)("option", __assign({ value: item }, { children: "".concat(totalCount, " / ").concat(item) }), (0, uuid_1.v4)())); }) })) })))] })))] })));
};
exports.Main = Main;
