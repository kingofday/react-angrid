...
var Main = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: 'paginate' }, { children: [(0, jsx_runtime_1.jsxs)("div", __assign({ className: 'paginateBox' }, { children: [showTotalRecord && ((0, jsx_runtime_1.jsx)("div", __assign({ className: 'textPage' }, { children: (0, jsx_runtime_1.jsxs)("div", { children: [textTotal, ": ", totalCount] }) }))), showCurrentPage && ((0, jsx_runtime_1.jsx)("div", __assign({ className: 'textPage' }, { children: totalCount && totalCount > pageSize && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [textCurrent, ": ", page] })) }))), showNumberOfPage && ((0, jsx_runtime_1.jsx)("div", __assign({ className: 'textPage' }, { children: totalCount && totalCount > pageSize && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [textNumber, ": ", totalPageCount] })) })))] })), totalCount && totalCount > pageSize && ((0, jsx_runtime_1.jsxs)("div", __assign({ className: 'paginateBox' }, { children: [(0, jsx_runtime_1.jsxs)("div", __assign({ className: 'paginate-nav' }, { children: [showPageArrow && ((0, jsx_runtime_1.jsx)("button", __assign({ onClick: function () {
                                    return pageChanging(PaginateType.PREV, 1);
                                }, type: 'button', className: page === 1 ? 'disabled' : '' }, { children: rtl ? (0, jsx_runtime_1.jsx)(icons_1.FiChevronRight, {}) : (0, jsx_runtime_1.jsx)(icons_1.FiChevronLeft, {}) }))), showPageNumber && ((0, jsx_runtime_1.jsx)("div", { children: slices.map(function (item) { return ((0, jsx_runtime_1.jsx)("button", __assign({ className: item === page ? 'active' : '', onClick: function () {
                            ...
                            } }, { children: range.map(function (item) { return ((0, jsx_runtime_1.jsx)("option", __assign({ value: item }, { children: rtl
                                    ? "".concat(item, " / ").concat(totalCount)
                                    : "".concat(totalCount, " / ").concat(item) }), (0, uuid_1.v4)())); }) })) })))] })))] })));
};
exports.Main = Main;
